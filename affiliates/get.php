...
if (!isset($_SESSION["indication_user"]) and !isset($_COOKIE["abbrevation"]) ) {
...
$lng= $details->longitude;
   ...
   $c_id=mysqli_fetch_assoc( mysqli_query($con, "select counts.id from counts where date='$date'"));
       setcookie("abbreviation",$abbreviation, "true", time()+ (86400 * 30), "/");
  setcookie("count",$c_id['id'], "true", time()+ (86400 * 30), "/");//86400=1 day
